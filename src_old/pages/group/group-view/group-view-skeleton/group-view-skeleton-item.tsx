...
import {groupViewSkeletonItemStyles} from './_styles';

const GroupViewSkeletonItem: FC = () => {
  const classes = groupViewSkeletonItemStyles();
...
export default GroupViewSkeletonItem;
