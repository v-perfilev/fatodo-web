...
export const withCaptcha = (Component: ComponentType<CaptchaProps>): FC => (props): ReactElement => {
...
export const withCaptchaProvider = (Component: ComponentType): FC => (props): ReactElement => {
  return (
