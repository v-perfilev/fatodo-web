...
export class TranslationUtils {
  ...
  public static getSnackTranslation = (message: string): string =>
    TranslationUtils.getTranslation('snack', message);

  public static getTranslation = (key: string, message: string): string =>
    message && i18n.exists(key + ':' + message) ? i18n.t(key + ':' + message) : null;
}
