...
export const ReorderIcon: FC<CommonProps<any>> = (props) => (
  <SvgIcon {...props}>
    ...
    <path fillRule="evenodd" clipRule="evenodd" d="M22.8673 19H11.4388C11.2377 19 10.7857 19.2693
      ...
      18H11.4388Z" fill="currentColor" />
    <path fillRule="evenodd" clipRule="evenodd" d="M3.85837 6.53981C2.39518 8.00247 1.47959 10.077
      1.47959 12.3821C1.47959 15.3014 2.94811 17.8506 5.1365 19.2553L4.61506 20.1018C2.14431 18.5159 0.5
      15.6485 0.5 12.3821C0.5 9.80273 1.52546 7.47227 3.173 5.82533L3.85837 6.53981Z" fill="currentColor" />
