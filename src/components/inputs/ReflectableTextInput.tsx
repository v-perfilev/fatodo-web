...
import React, {ChangeEvent, HTMLAttributes, KeyboardEvent, useEffect, useRef} from 'react';
import {InputUtils} from '../../shared/utils/input.utils';
import {TextFieldProps} from '@material-ui/core';
import {RefUtils} from '../../shared/utils/ref.utils';

type ReflectableTextInputProps = HTMLAttributes<HTMLElement> &
  TextFieldProps & {
    placeholder: string;
    action: () => void;
    text: string;
